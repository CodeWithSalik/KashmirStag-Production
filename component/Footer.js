      ...
      <footer className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
            <Link legacyBehavior href={"/"}>
              <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900 mb-px-8">
                <Image src="/logo.png" alt="" width={200} height={100} />

              </a>
            </Link>
            <p className="mt-2 text-xl font-bold text-gray-500 px-6">Always be premium with KashmirStag</p>
          </div>
          <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <Link href={'/returnpolicy'} className="text-gray-600 hover:text-gray-800">Refund & Return Policy</Link>
                </li>
              </nav>
            </div>
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
              ...
              <nav className="list-none mb-10">
                ...
                <li>
                  <Link href={'/termsandcons'} className="text-gray-600 hover:text-gray-800">Terms and Conditions</Link>
                </li>
              </nav>
            </div>
          </div>
        ...
        <div className="bg-gray-100">
          <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 KashmirStag.com —
              <a> Developed by CodeWithSalik</a>
            </p>
            <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start">
              ...
              <a href='https://instagram.com/thekashmirstag?igshid=MzRlODBiNWFlZA==' className="ml-3 text-gray-500">
